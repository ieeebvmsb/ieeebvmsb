  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center"
                ...
                <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    <!-- <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span
                            class="mx-auto"><a href="index.php">Home</a></span> <span class="mx-auto">Blog</span></p> -->
                    <h1 class="mb-3 mx-auto bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Our Team</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="ftco-section" style="padding: 3em 0;">
        <div class="container">
            ...
            <div class="row mt-1">
                <div class="col-md-3 mx-auto mb-3 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Executive Officer/himanshu.jpg" alt="himanshu" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Himanshu Thacker</span>
                            <span class="position">Public Relations Officer | <a href="https://www.linkedin.com/in/himanshuthacker
                ...
                <div class="col-md-3 mx-auto mb-3 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Executive Officer/chintan.jpg" alt="chintan" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Chintan Pandya</span>
                            <span class="position">Membership Development Officer | <a href="https://www.linkedin.com/in/chintan-pandya-310777185/"><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mx-auto mb-3 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Executive Officer/harshmodi.jpg" alt="harsh" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Harsh Modi</span>
                            <span class="position">Inventory Officer | <a href="https://www.linkedin.com/in/harsh-modi-8a4bb8176/"><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid text-center text-md-l">
                    <div class="container-fluid m-0 p-0 row">
                        <div class="col-md-6 mt-md-0 mt-3 row ft-content">
                            <h5 class="text-uppercase font-weight-bold col-12" style="height: fit-content;">External
                                Links
                            </h5>

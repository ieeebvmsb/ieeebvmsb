      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">SB Events</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row block-9">
          ...
          <div class="col-md-12 pr-md-5" align="center">
            <table align='center' border="3">
              ...
              ?>
              <tr>
                <td style="padding:10px"><?php echo $row['EventTitle']; ?></td>
                <td style="padding:10px"><a href="updateDetails.php?eventCode=<?php echo $row['EventCode']; ?>" style="color: #0000FF;"><u>Update Event</u></a></td>
                <td style="padding:10px"><a href="deleteEvent.php?eventCode=<?php echo $row['EventCode']; ?>" style="color: #0000FF;"><u>Delete Event</u></a></td>
              </tr>
              <?php
                }
              ?>

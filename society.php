      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a href="society.php" class="nav-link">Society</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Societies</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row no-gutters justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-4">Our Socities</h2>

          </div>
        </div>
        <div class="row">
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a href="events.php" class="image" style="background-image: url('images/NPSS.png');  "
              data-scrollax=" properties: { translateY: '-20%'}">
            </a>
            <div class="text">

              <h2 class="heading"><a href="events.php">NPSS Society</a></h2>
              <p align="justify">Nuclear and Plasma Science Society was originated in 2018 at IEEE BVM SB as the Professional Group
                 on Nuclear Science within the IRE. The IEEE Nuclear and Plasma Sciences Society (NPSS) covers the
                 fields of Fusion Technology, Nuclear Medical and Imaging Sciences, Particle Accelerator Science and
                 Technology, Pulsed Power Systems, Radiation Effects, Radiation Instrumentation, Plasma Sciences and
                 Applications, Standards for Nuclear Instruments and Detectors,
                 and Computer Applications in Nuclear and Plasma Sciences.</p>
              <p><a href="https://ieee-npss.org/" class="btn btn-primary px-4">Know More</a></p>
            </div>
          </div>

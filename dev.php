        ...
        <div class="container">
            <div class="row justify-content-center  pb-5">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    ...
                    <h2 class="mb-4">Developer Team</h2>
                </div>
            </div>
            <div class="row mt-1 mb-5">
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Developer Team/khanjan.jpg" alt="khanjan" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Khanjan Marthak</span>
                            <span class="position">Core Web Developer | <a href="https://www.linkedin.com/in/khanjan-marthak-5b88b619a/"><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Developer Team/Sneh.jpg" alt="Sneh" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Sneh Trivedi</span>
                            <span class="position">Core Web Developer | <a href="https://www.linkedin.com/in/sneh-trivedi-ba7425190/"><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
            </div>

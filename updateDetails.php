...
if($type == "Admin"){
  ...
  $q="SELECT * FROM events WHERE EventCode = '$eventCode'";
  $sql=mysqli_query($conn,$q);
  $row=mysqli_fetch_assoc($sql);
  $_SESSION['oldEventType'] = $row['EventType'];
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Update Event Details</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container bg-light">
        ...
        <div class="row block-9">
          ...
          <div class="col-md-12 pr-md-5">
            <form action="updateEvent.php" method="POST" align="center" enctype="multipart/form-data">
              <div class="form-group">
                <input type="text" name="eventTitle" placeholder="Event Title" value="<?php echo $row['EventTitle']; ?>">
                &nbsp;&nbsp;&nbsp;
                <input type="text" name="eventReport" placeholder="Event Report Link" value="<?php echo $row['EventReport']; ?>">
              </div>
              <div class="form-group">
                <p>Event Abstract</p>
                <textarea name="eventAb" rows="10" cols="100"><?php echo $row['EventAbstract']; ?></textarea>
              </div>
              <div class="form-group">
                <p>Event Type</p>
                <select name="eventType" placeholder="Event Type" >
                  <option value="ET">Event Type</option>
                  <option value="Flagship" <?php echo (($row['EventType']=='Flagship')?'Selected':''); ?>>Flagship Event</option>
                  <option value="Other" <?php echo (($row['EventType']=='Other')?'Selected':''); ?>>Other Event</option>
                </select>
              </div>
              <div class="form-group">
                <p>Event Description</p>
                <textarea name="eventDes" rows="20" cols="100"><?php echo $row['EventDescription']; ?></textarea>
              </div>
              <div class="form-group">
                <p>Event Start Date</p>
                <input type="date" name="eventStartDate" placeholder="Event Start Date" value="<?php echo $row['EventStartDate']; ?>">
              </div>
              <div class="form-group">
                <p>Event End Date</p>
                <input type="date" name="eventEndDate" placeholder="Event End Date" value="<?php echo $row['EventEndDate']; ?>">
              </div>
              <br>
              <div class="form-group">
                <input type="submit" name="updateDetails" value="Update Event Details" class="btn btn-primary py-3 px-5">
              </div>
            </form>
          </div>
        </div>

        ...
        <div class="container">
            <div class="row justify-content-center  pb-5">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    ...
                    <h2 class="mb-4">Branch Reprensentatives</h2>
                </div>
            </div>
            <div class="row mt-1 mb-5">
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Branch Representatives/Jaimin.png" alt="jaimin" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Jaimin Shimpi</span>
                            <span class="position">IT Branch Co-ordinator | <a href="https://www.linkedin.com/in/jaimin-shimpi
                ...
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Branch Representatives/galav.jpeg" alt="galav" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Galav Bhatt</span>
                            <span class="position">Electrical Branch Co-ordinator | <a href="https://www.linkedin.com/in/galav-bhatt-a783b8179
                                "><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Branch Representatives/dhruv.jpg" alt="dhruv" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Dhruv Pokar</span>
                            <span class="position">Electrical Branch Co-ordinator | <a href="https://www.linkedin.com/in/dhruv-pokar-910377180
                                "><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3 mx-auto mb-5 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Branch Representatives/rutvik.jpg" alt="rutvik" class="img-fluid img-s mb-3">
                        <div class="person-info mb-1">
                            <span class="name">Rutvik Maheshwari</span>
                            <span class="position">E.C. Branch Co-ordinator | <a href="https://www.linkedin.com/in/rutvik-maheshwari-44827a190
                                "><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mx-auto mb-5 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Branch Representatives/ibrahim.jpg" alt="ibrahim" class="img-fluid img-s mb-3">
                        <div class="person-info mb-1">
                            <span class="name">Ibrahim Koicha</span>
                            <span class="position">EL Branch Co-ordinator | <a href="https://www.linkedin.com/in/ibrahim-koicha
                                "><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mx-auto mb-5 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Branch Representatives/jay.jpg" alt="jay" class="img-fluid img-s mb-3">
                        <div class="person-info mb-1">
                            <span class="name">Jay Prajapati</span>
                            <span class="position">ME Branch Co-ordinator | <a href="https://www.linkedin.com/in/jayprajapati009
                                "><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>

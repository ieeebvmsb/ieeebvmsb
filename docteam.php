        ...
        <div class="container">
            <div class="row justify-content-center  pb-5">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    ...
                    <h2 class="mb-4">Documentation Team</h2>
                </div>
            </div>
            <div class="row mt-1 mb-5">
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Documentation Team/kruti.jpg" alt="kruti" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Kruti Kamdar</span>
                            <span class="position">Documentation Lead | <a href="https://www.linkedin.com/in/kruti-k-a410abb2"><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Documentation Team/Vatsal.png" alt="vatsal" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Vatsal Shah</span>
                            <span class="position">Documentation Lead | <a href="https://www.linkedin.com/in/vatsal-shah-92390417b/"><i class="fa fa-linkedin"></a></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Documentation Team/gaurav.jpg" alt="gaurav" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Gaurav Barve</span>
                            <span class="position">Team Member | <a href="https://www.linkedin.com/in/gauravbarve2"><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Documentation Team/dhruv.jpg" alt="dhruv" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Dhruv Pokar</span>
                            <span class="position">Team Member | <a href="https://www.linkedin.com/in/dhruv-pokar-910377180/"><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
            </div>

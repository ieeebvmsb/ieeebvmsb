        ...
        <div class="container">
            <div class="row justify-content-center  pb-5">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    ...
                    <h2 class="mb-4">Publicity Team</h2>
                </div>
            </div>
            <div class="row mt-1 mb-5">
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Publicity Team/drashti.jpg" alt="dhrasti" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Drashti Shah</span>
                            <span class="position">Publicity Lead | <a href="https://www.linkedin.com/in/drashti-shah-6b4777185/"><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Publicity Team/fenil.png" alt="fenil" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Fenil Ghoghari</span>
                            <span class="position">Team Member | <a href="https://www.linkedin.com/in/fenilghoghari
                ...
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Publicity Team/umang.jpg" alt="umang" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Umang Patoliya</span>
                            <span class="position">Team Member | <a href="https://www.linkedin.com/in/umang-patoliya-7410901a7/"><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
            </div>

        ...
        <div class="container">
            <div class="row justify-content-center  pb-5">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    ...
                    <h2 class="mb-4">NPSS Chapter<br>Executive Committee</h2>
                </div>
            </div>
            <div class="row mt-1 mb-5">
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/NPSS Committee/Rudrax.png" alt="rudrax" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Rudrax Dave</span>
                            <span class="position">Chairperson, NPSS Chapter | <a href="https://www.linkedin.com/in/rudrax-dave-358627187
                ...
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/NPSS Committee/Vatsal.png" alt="vatsal" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Vatsal Shah</span>
                            <span class="position">Secretary, NPSS Chapter | <a href="https://www.linkedin.com/in/vatsal-shah-92390417b/">
                              <i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>

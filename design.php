        ...
        <div class="container">
            <div class="row justify-content-center  pb-5">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    ...
                    <h2 class="mb-4">Design Team</h2>
                </div>
            </div>
            <div class="row mt-1">
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Design Team/harsh.png" alt="harsh" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Harsh Navadiya</span>
                            <span class="position">Design Lead | <a href="https://www.linkedin.com/in/harsh-navadiya-050769186
                ...
                <div class="col-md-3 mx-auto mb-4 ftco-animate">
                    <div class="block-10">
                        <img src="images/team/Images/Design Team/deep.png" alt="deep" class="img-fluid img-s mb-4">
                        <div class="person-info mb-1">
                            <span class="name">Deep Sakhiya</span>
                            <span class="position">Design Lead | <a href="https://www.linkedin.com/in/deep-sakhiya-a0560418a
                              "><i class="fa fa-linkedin"></i></a></span>
                        </div>
                    </div>
                </div>
